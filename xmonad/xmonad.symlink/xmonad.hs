---------------------------------------------------------------------------------------------------------
-- shamelessly copied and modified from https://wiki.haskell.org/Xmonad/Config_archive/And1%27s_xmonad.hs
...
myFont = "-*-terminus-medium-r-normal-*-11-*-*-*-c-*-*-*"
myIconDir = "/home/dluo/.dzen"
