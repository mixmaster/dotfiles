...
-- https://github.com/nnoell/dotfiles/tree/master/v4.4 by nnoell.                         --
--------------------------------------------------------------------------------------------
...
boxLeftIcon    = "/home/dluo/.xmonad/xbm_icons/boxleft.xbm" --left icon of dzen boxes
boxLeftIcon2   = "/home/dluo/.xmonad/xbm_icons/boxleft2.xbm" --left icon2 of dzen boxes
boxRightIcon   = "/home/dluo/.xmonad/xbm_icons/boxright.xbm" --right icon of dzen boxes
...
myStartupHook =
	...
	(spawn "/usr/bin/feh --bg-scale ~/Pictures/images-for-dark-metal-wallpaper.jpg") <+>
